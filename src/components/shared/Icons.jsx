export default function Icon({ name, size = 24, className = "" }) {
  ...
  const icons = {
    ...
    download: (
      <svg {...commonProps} className={`lucide lucide-download-icon ${className}`}>
        <path d="M12 15V3" />
    ...
    eye: (
      <svg {...commonProps} className={`lucide lucide-eye-icon ${className}`}>
        <path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0" />
        <circle cx="12" cy="12" r="3" />
      </svg>
    ),
    bell: (
      <svg {...commonProps} className={`lucide lucide-bell-icon ${className}`}>
    ...
    play: (
      <svg {...commonProps} strokeWidth="4" className={`lucide lucide-check-icon ${className}`}>
