...
export default function ModalNuevaCita({
  ...
  >
    <div
      className="bg-white rounded-xl shadow-lg p-6 md:w-[1000px] w-84 max-h-[85vh] overflow-y-auto relative z-50"
        ...
        <div className="p-4 border rounded-lg bg-gray-50 mb-6">
          ...
          <div className="relative w-full mt-3">
            ...
            <Input
              ...
              className="
                w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm 
          ...
          {searchResults.length > 0 && (
            <ul className="mt-2 border rounded-md max-h-48 overflow-y-auto bg-white">
                ...
                {diasMes.map((diaObj, i) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={disabled}
                      className={`p-2 rounded border text-sm select-none ${color} ${
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setCitasData((prev) => prev.filter((_, idx) => idx !== i))
                        }
